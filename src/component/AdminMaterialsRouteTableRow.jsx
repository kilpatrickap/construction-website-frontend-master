...
class AdminMaterialsRouteTableRow extends Component {
	...
	delete() {
		axios
			.get("https://morning-shore-28533.herokuapp.com/materials/delete/" + this.props.obj._id)			//before: ("https://morning-shore-28533.herokuapp.com/materials/materials/delete/")	
